...
class Oborci_Model {
    ...
    /**
     * The field name for storing the created timestamp.
     * @var array
     */
    private $db_created_field = NULL;

    /**
     * The field name for storing the updated timestamp.
     * @var array
     */
    private $db_updated_field = NULL;

    /**
     * If set to TRUE, will use 'Unix Timestamp' instead of 'DateTime'
     * @var array
     */
    private $unix_timestamp = FALSE;
    // CONSTRUCTS
    // ---------------------------------------------------------------- //
    ...
    public function insert_with($model_name, $model_data, $data=NULL)
    {
        ...
        switch ($relation)
        {
            case 'belongs_to': $returns = $this->_insert_with_belongs_to($model_name, $model_data, $data);
                break;
            case 'has_one':
            case 'has_many': $returns = $this->_insert_with_has_one($model_name, $model_data, $data);
                break;
            case 'has_and_belongs_to_many': $returns = $this->_insert_with_has_and_belongs_to_many($model_name, $model_data, $data);
                break;
        }
    ...
    public function find_from($model, $field_value)
    {
        ...
        if (is_array($rules))
        {
            ...
            switch ($relation)
            {
                case 'has_one': $returns = $this->_find_has_one($model, $field_value);
                    break;
                case 'belongs_to': $returns = $this->_find_belongs_to($model, $field_value);
                    break;
                case 'has_many': $returns = $this->_find_has_many($model, $field_value);
                    break;
                case 'has_and_belongs_to_many': $returns = $this->_find_has_and_belongs_to_many($model, $field_value);
                    break;
            }
        }
    ...
    public function update_with($field_value, $model_name, $model_data, $data=NULL)
    {
        ...
        switch ($relation)
        {
            case 'belongs_to': $returns = $this->_update_with_belongs_to($field_value, $model_name, $model_data, $data);
                break;
            case 'has_one': $returns = $this->_update_with_has_one($field_value, $model_name, $model_data, $data);
                break;
        }
    ...
    public function delete_with($field_value, $model_name)
    {
        ...
        switch ($relation)
        {
            case 'belongs_to': $returns = $this->_delete_with_belongs_to($field_value, $model_name);
                break;
            case 'has_one':
            case 'has_many': $returns = $this->_delete_with_has_one($field_value, $model_name);
                break;
            case 'has_and_belongs_to_many': $returns = $this->_delete_with_has_and_belongs_to_many($field_value, $model_name);
                break;
        }
    ...
    public function __call($name, $arguments)
    {
        ...
        {
            // before methods
            case 'before_insert': return $this->$callback_method($arguments[0]);
                break;
            case 'before_insert_with': return $this->$callback_method($arguments[0], $arguments[1], $arguments[2]);
                break;
            case 'before_find': return $this->$callback_method($arguments[0]);
                break;
            case 'before_find_all': return $this->$callback_method();
                break;
            case 'before_find_where': return $this->$callback_method($arguments[0]);
                break;
            case 'before_find_one': return $this->$callback_method($arguments[0]);
                break;
            case 'before_find_from': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'before_update': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'before_update_all': return $this->$callback_method($arguments[0]);
                break;
            case 'before_update_where': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'before_update_with': return $this->$callback_method($arguments[0], $arguments[1], $arguments[2], $arguments[3]);
                break;
            case 'before_delete': return $this->$callback_method($arguments[0]);
                break;
            case 'before_delete_all': return $this->$callback_method();
                break;
            case 'before_delete_where': return $this->$callback_method($arguments[0]);
                break;
            case 'before_delete_with': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            // after methods
            case 'after_insert': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'after_insert_with': return $this->$callback_method($arguments[0], $arguments[1], $arguments[2], $arguments[3]);
                break;
            case 'after_find': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'after_find_all': return $this->$callback_method($arguments[0]);
                break;
            case 'after_find_where': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'after_find_one': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'after_find_from': return $this->$callback_method($arguments[0], $arguments[1], $arguments[2]);
                break;
            case 'after_update': return $this->$callback_method($arguments[0], $arguments[1], $arguments[2]);
                break;
            case 'after_update_all': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'after_update_where': return $this->$callback_method($arguments[0], $arguments[1], $arguments[2]);
                break;
            case 'after_update_with': return $this->$callback_method($arguments[0], $arguments[1], $arguments[2], $arguments[3], $arguments[4]);
                break;
            case 'after_delete': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'after_delete_all': return $this->$callback_method($arguments[0]);
                break;
            case 'after_delete_where': return $this->$callback_method($arguments[0], $arguments[1]);
                break;
            case 'after_delete_with': return $this->$callback_method($arguments[0], $arguments[1], $arguments[2]);
                break;
        }
    }
